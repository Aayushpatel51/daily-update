...
| T08 | Build bounded source experiment harness | Build | T07 | Review | [Harness and verification](research/T08_SOURCE_HARNESS.md) ready; Reproducible fetch/parse runs with timeout, response cap, redirect checks, cursor/hash and fixture output; invalid or unchanged content does not become a new event |
